...
class UnitStats {
  ...
  function __construct($brex_unit_stats) {
    $this->hp = $brex_unit_stats->pv + floor($brex_unit_stats->pv_pots * 1.5);
    ...
    $this->mp = $brex_unit_stats->pm + floor($brex_unit_stats->pm_pots * 1.5);
    ...
    $this->atk = $brex_unit_stats->att + floor($brex_unit_stats->att_pots * 1.5);
    ...
    $this->mag = $brex_unit_stats->mag + floor($brex_unit_stats->mag_pots * 1.5);
    ...
    $this->def = $brex_unit_stats->def + floor($brex_unit_stats->def_pots * 1.5);
    ...
    $this->spr = $brex_unit_stats->psy + floor($brex_unit_stats->psy_pots * 1.5);
