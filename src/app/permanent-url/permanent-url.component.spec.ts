...
describe('PermanentUrlComponent', () => {
  ...
  it('should construct a URL based on unit equipment and display it in the HTML input field', () => {
    ...
    component.unit = unit;
    component.right_hand = unit.selectedEquipmentSet.right_hand;
    component.left_hand = unit.selectedEquipmentSet.left_hand;
    component.head = unit.selectedEquipmentSet.head;
    component.body = unit.selectedEquipmentSet.body;
    component.accessory1 = unit.selectedEquipmentSet.accessory1;
    component.accessory2 = unit.selectedEquipmentSet.accessory2;
    component.materia1 = unit.selectedEquipmentSet.materia1;
    component.materia2 = unit.selectedEquipmentSet.materia2;
    component.materia3 = unit.selectedEquipmentSet.materia3;
    component.materia4 = unit.selectedEquipmentSet.materia4;
    component.rh_trait1 = unit.selectedEquipmentSet.rh_trait1;
    component.rh_trait2 = unit.selectedEquipmentSet.rh_trait2;
    component.rh_trait3 = unit.selectedEquipmentSet.rh_trait3;
    component.lh_trait1 = unit.selectedEquipmentSet.lh_trait1;
    component.lh_trait2 = unit.selectedEquipmentSet.lh_trait2;
    component.lh_trait3 = unit.selectedEquipmentSet.lh_trait3;
