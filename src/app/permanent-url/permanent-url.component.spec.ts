...
describe('PermanentUrlComponent', () => {
  ...
  it('should construct a URL based on unit equipment and display it in the HTML input field', () => {
    ...
    component.unit = unit;
    component.right_hand = unit.selectedBuild.selectedEquipmentSet.right_hand;
    component.left_hand = unit.selectedBuild.selectedEquipmentSet.left_hand;
    component.head = unit.selectedBuild.selectedEquipmentSet.head;
    component.body = unit.selectedBuild.selectedEquipmentSet.body;
    component.accessory1 = unit.selectedBuild.selectedEquipmentSet.accessory1;
    component.accessory2 = unit.selectedBuild.selectedEquipmentSet.accessory2;
    component.materia1 = unit.selectedBuild.selectedEquipmentSet.materia1;
    component.materia2 = unit.selectedBuild.selectedEquipmentSet.materia2;
    component.materia3 = unit.selectedBuild.selectedEquipmentSet.materia3;
    component.materia4 = unit.selectedBuild.selectedEquipmentSet.materia4;
    component.rh_trait1 = unit.selectedBuild.selectedEquipmentSet.rh_trait1;
    component.rh_trait2 = unit.selectedBuild.selectedEquipmentSet.rh_trait2;
    component.rh_trait3 = unit.selectedBuild.selectedEquipmentSet.rh_trait3;
    component.lh_trait1 = unit.selectedBuild.selectedEquipmentSet.lh_trait1;
    component.lh_trait2 = unit.selectedBuild.selectedEquipmentSet.lh_trait2;
    component.lh_trait3 = unit.selectedBuild.selectedEquipmentSet.lh_trait3;
