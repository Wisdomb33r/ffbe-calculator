...
const SKILLS_TEST_DATA = '[{"category":7,"power":500,"hits":5,"frames":"10 20 30 40 50","damages":"10 20 30 30 10","damages_type":"magical","isTurnCounting":true},{"category":7,"power":1000,"hits":4,"frames":"10 20 30 40","damages":"10 20 30 40","damages_type":"magical","isTurnCounting":true}]';
...
describe('AlgorithmChaining', () => {
  ...
  it('#calculate should set the result object values', () => {
    ...
    expect(result.result).toBeCloseTo(36.283);
