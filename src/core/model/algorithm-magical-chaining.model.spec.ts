...
const BUILD_TEST_DATA = '{"algorithmId":2,"equipments":' + EQUIPMENTS_TEST_DATA + ',"skills":' + SKILLS_TEST_DATA + '}';
...
describe('AlgorithmMagicalChaining', () => {
  ...
  it('#calculate should set the result object values', () => {
    ...
    expect(result.result).toBeCloseTo(28.105);
    ...
    expect(result['preSprDamages']).toEqual(30384000);
