...
describe('DatabaseClientService', () => {
  ...
  it('should delegate to HttpClient for pushing equipment to backend',
    inject([DatabaseClientService], (service: DatabaseClientService) => {
      ...
      unit.selectedBuild.selectedEquipmentSet.left_hand = {id: 10} as Equipment;
      unit.selectedBuild.selectedEquipmentSet.rh_trait1 = {id: 11} as Equipment;
      unit.selectedBuild.selectedEquipmentSet.rh_trait2 = {id: 12} as Equipment;
      unit.selectedBuild.selectedEquipmentSet.rh_trait3 = {id: 13} as Equipment;
      unit.selectedBuild.selectedEquipmentSet.lh_trait1 = {id: 14} as Equipment;
      unit.selectedBuild.selectedEquipmentSet.lh_trait2 = {id: 15} as Equipment;
      unit.selectedBuild.selectedEquipmentSet.lh_trait3 = {id: 16} as Equipment;
      // WHEN
